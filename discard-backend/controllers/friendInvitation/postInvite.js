...
const postInvite = async (req, res) => {
  ...
  // check if friend that we would lik to invite is not user
  ...
  // if invitation has been successfully created we would like to update friend invitations if other user is online
